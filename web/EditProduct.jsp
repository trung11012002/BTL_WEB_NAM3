                        ...
                        <form action="editproduct" method="get">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${detail.product_id}" name="pid" type="text" class="form-control" readonly="" required>
                                </div>
                                <div class="form-group">
                                    <label>Tên</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${detail.quantityM}" name="quantityM" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Số lượng L</label>
                                    <input value="${detail.quantityL}" name="quantityL" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Số lượng XL</label>
                                    <input value="${detail.quantityXL}" name="quantityXL" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Số lượng 2XL</label>
                                    <input value="${detail.quantity2XL}" name="quantity2XL" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Price</label>
